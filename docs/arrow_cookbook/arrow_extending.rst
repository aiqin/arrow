...
Additionally, Arrow provides the concept of `complex scenarios, <./arrow_in-depth.html#complex-test-scenarios>`_ you can create a *scenario* using a combination of the *default*, *hybridApp* and the `locator controller. <./arrow_in-depth.html#the-locator-controller>`_
...
All controllers, including *default* , *hybridApp* and *locator* extend from the same **controller** interface. The **controller** interface provides you the following methods:
