...
function HybridAppController(testConfig, testParams, driver) {
    Controller.call(this, testConfig, testParams, driver);

    this.logger = log4js.getLogger("HybridAppController");
}

util.inherits(HybridAppController, Controller);

HybridAppController.prototype.execute = function (callback) {
    var self = this,
    ...
    if (!webdriver) {
        callback("HybridApp controller is only supported for the hybridApp driver");
        return;
    }
...
module.exports = HybridAppController;
