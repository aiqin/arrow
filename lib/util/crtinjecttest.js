...
document.write('<' + 'script type="'+'text/javascript'+'">'+'sessionId='+"''"+'; goog.require('+"'bot.dom'"+');'+'goog.require('+"'core.firefox'"+');'+'goog.require('+"'core.text'"+');'+'goog.require('+"'core.events'"+');'+'</script>');
