package com.yahoo.platform.crt.activity;
...
import com.yahoo.platform.mobile.crt.app.RTActivity;
import com.yahoo.platform.mobile.crt.app.RTWebView;

public class CocktailsRTActivity extends RTActivity implements OnClickListener{
    private final static String TAG = "CocktailsRTActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mWebview = createRTWebView(ly, lyParams, null);
        mWebview.loadUrl("crt://yahoo.com/yahoo.application.oo/index.html");
    }
