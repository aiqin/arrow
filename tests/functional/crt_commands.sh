...
arrow data/crt_test/crt-test-func.js --page=crt://yahoo.com/yahoo.application.oo/index.html --driver=crt --reuseSession=true
# function test with --parallel option
arrow data/crt_test/crt-test-func.js --page=crt://yahoo.com/yahoo.application.oo/index.html --driver=crt --parallel=2
